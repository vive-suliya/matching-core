...
상세한 작동 원리는 [Workflow 페이지](https://matching-core.vercel.app/workflow)에서 확인할 수 있습니다.
...
상세한 기술적 강점은 [Advantages 페이지](https://matching-core.vercel.app/advantages)에서 확인할 수 있습니다.
...
- [Frontend Dashboard 바로가기](https://matching-core.vercel.app/playground)

### 2. 살아있는 문서 (Live Documentation)
- **Swagger UI**를 통해 API 명세를 확인하고 즉시 테스트할 수 있습니다.
- [API Docs 바로가기](https://matching-core-api.railway.app/api/docs)
